...
/**
 * This is a helper class which is used for logging into the application Only this class should be used for logging in
 * the application. This will maitain a cache of all the logging in the application.
 * 
 * @author puneetbehl
 */
